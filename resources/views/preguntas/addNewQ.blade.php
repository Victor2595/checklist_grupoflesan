<div class="form-grou row">
    <div class="align-self-center col col-md-6 col-lg-6 col-sm-12 col-xs-12">
        <label id="labelTipo" for="selectTipo">Tipo Checklist</label>
        <select id="selectTipo" required readonly name="selectTipo" class="form-control tipo-pregunta" autofocus="autofocus">
