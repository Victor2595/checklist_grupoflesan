                                ...
                                <tr class="{{ $tbl_p->id_cabecera }}">
                                  ...
                                  <th>
                                    ...
                                    @if(count($tbl_p->hijo) == 0)
                                      ...
                                      @else
                                      <a href="{{ route('states_preguntas',$tbl_p->id_cabecera) }}" class="btn btn-danger btn-sm" value="Inactivar" style="font-size: 80%;" title="Inactivar"><i class="fa fa-trash-alt"></i></a></th>
                                      @endif
                                    @endif
                                </tr> 
                                <?php $count=1 ?>                                 
                                @foreach($tbl_p->hijo as $tbl_h)
                                  <tr class="{{ $tbl_h->clbod_preguntas_item_id }}">
                                    ...
                                    <td>
                                      ...
                                      @else
                                      <a href="{{ route('states_preguntas',$tbl_h->clbod_preguntas_item_id) }}" class="btn btn-danger btn-sm" value="Eliminar" style="font-size: 80%;" title="Inactivar"><i class="fa fa-trash-alt"></i></a>
                                      @endif
                                    </td>
                                  </tr>
                                  <?php $count++; ?>
