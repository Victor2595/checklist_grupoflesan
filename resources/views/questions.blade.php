                    ...
                    <div role="tabpanel">
                      <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item active">
                          <a class="nav-link " id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home">Preguntas Almacén</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile">Preguntas Visita</a>
                        </li>
                      </ul>
                      <div class="tab-content" id="myTabContent">
                            ...
                            <tbody>
                              @foreach($arreglo as $tbl_p)
                                ...
                                <tr class="{{ $tbl_p->id_cabecera }}">
                                  ...
                                  <th>
                                    <a href="#" class="btn btn-primary btn-sm showAjaxModal" data-titulo="Agregar Pregunta Almacén" data-action="addPregunta" data-enlace="/addNewPregunta" data-tipo="{{ $tbl_p->id_cabecera }}" data-select="{{ $tbl_p->tipo }}" value="Agregar" title="Agregar" style="font-size: 90%;"><i class="fa fa-plus"></i></a>
                        ...
                        <div class="tab-pane" id="profile" role="tabpanel">
                          <br>    
                          <a class="btn btn_agregar bg-danger text-white showAjaxModal btn-sm" data-titulo="Agregar Pregunta Cabecera Visita" data-action="addPregunta" data-enlace="/addNewPregunta" data-tipo="0" data-select="0" data-tabla="2"><i class="fa fa-user-plus"></i> Agregar Pregunta Cabecera</a>
                          <br>
                          <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                            <thead class="thead-dark">
                              <tr>
                            ...
                            <tbody>
                              @foreach($arreglo as $tbl_p)
                                ...
                                <tr class="{{ $tbl_p->id_cabecera }}">
                                  ...
                                  <th colspan="3">{{ $tbl_p->cabecera }}</th>
                                  <th>
                                    <a href="#" class="btn btn-primary btn-sm showAjaxModal" data-titulo="Agregar Pregunta Visita" data-action="addPregunta" data-enlace="/addNewPregunta" data-tipo="{{ $tbl_p->id_cabecera }}" data-select="{{ $tbl_p->tipo }}" value="Agregar" title="Agregar" style="font-size: 90%;"><i class="fa fa-plus"></i></a>
                                    <a href="#" class="btn btn-info btn-sm showAjaxModal" data-titulo="Editar Topico" data-tipo="0" title="Editar" data-action="editPregunta" data-enlace="/editOldPregunta/{{ $tbl_p->id_cabecera  }}" data-select="{{ $tbl_p->tipo }}" style="font-size: 90%;"><i class="fas fa-pen"></i></a>
                                    @if(count($tbl_p->hijo) == 0)
                                      @if($tbl_p->estado == 0)
                                      <a href="{{ route('states_preguntas',$tbl_p->id_cabecera) }}" class="btn btn-success btn-sm" value="Activar" style="font-size: 80%;" title="Activar"><i class="fa fa-thumbs-up"></i></a>    
