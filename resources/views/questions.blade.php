                              ...
                              @foreach($arreglo as $tbl_p)
                                ...
                                @foreach($tbl_p->hijo as $tbl_h)
                                  <tr class="{{ $tbl_h->clbod_preguntas_item_id }}">
                                    ...
                                    <td>
                                      <a href="#" class="btn btn-info btn-sm showAjaxModal" data-titulo="Editar Pregunta" data-tipo="1" title="Editar" data-action="editPregunta" data-enlace="/editOldPregunta/{{ $tbl_h->clbod_preguntas_item_id  }}" data-select="0" style="font-size: 90%;"><i class="fas fa-pen"></i></a>
