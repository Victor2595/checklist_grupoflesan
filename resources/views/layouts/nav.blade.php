   ...
   <header id="header">
        <div class="container-fluid">
            <div id="logo" class="pull-left">
                <a href=""><img src="https://www.gestionflesan.cl/controlflujo/images/grupo_flesan.png" alt="grupoflesan.png"  title="GRUPO FLESAN | Confianza que Construye" /></a>
            </div>
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    <li class="menu-has-children" id="nav-ad"><a href="{{ route('principal') }}"> Checklist de Bodega</a></li>
